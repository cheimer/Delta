...
- **다양한 공격 패턴**:
  - 지상: Bite, Claws, SpitFire, SpreadFire
  - 비행: FlySpitFire, FlySpreadFire

### 5. 난이도 시스템 (Difficulty System)
- **3단계 난이도**: Easy, Normal, Hard
- **동적 밸런싱**:
  - 적 체력 조정 (Easy: 0.7x, Normal: 1.0x, Hard: 1.3x)
  - 적 공격력 조정 (Easy: 0.7x, Normal: 1.0x, Hard: 1.5x)
  - 플레이어 피해 조정
- **저장/로드 지원**: 난이도 설정 저장
...
- **Delta Types**: 네이밍 등의 중앙화 관리
    - DeltaEnumTypes (난이도, 팀 소속, 스킬 타입 등)
    - DeltaNamespaceTypes
    - DeltaStructTypes
