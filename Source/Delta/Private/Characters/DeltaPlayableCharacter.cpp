...
void ADeltaPlayableCharacter::SetTickWithComponents(bool bIsEnable)
{
	SetActorTickEnabled(bIsEnable);

	if (CameraComponent)
	{
		CameraComponent->SetComponentTickEnabled(bIsEnable);
	}
	if (SpringArmComponent)
	{
		SpringArmComponent->SetComponentTickEnabled(bIsEnable);
	}
